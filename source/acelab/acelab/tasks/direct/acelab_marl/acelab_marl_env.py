...
from .acelab_marl_env_cfg import AcelabMarlEnvCfg


class AcelabMarlEnv(DirectMARLEnv):
    cfg: AcelabMarlEnvCfg

    def __init__(self, cfg: AcelabMarlEnvCfg, render_mode: str | None = None, **kwargs):
